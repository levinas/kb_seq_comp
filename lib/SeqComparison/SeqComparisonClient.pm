package SeqComparison::SeqComparisonClient;
...
SeqComparison::SeqComparisonClient
...
sub new
{
    ...
    my $self = {
	client => SeqComparison::SeqComparisonClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for SeqComparison::SeqComparisonClient\n";
    }
    if ($sMajor == 0) {
        warn "SeqComparison::SeqComparisonClient version is $svr_version. API subject to change.\n";
    }
}
...
package SeqComparison::SeqComparisonClient::RpcClient;
